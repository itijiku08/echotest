...
if not os.path.exists(clone_dir):
    # Gitリポジトリをクローンする
    subprocess.run(["git", "clone", "https://github.com/echonet/dynamic.git", clone_dir], check=True)
else:
    print(f"Directory '{clone_dir}' already exists.")
    
setup_py_directory = "dynamic-master"
...
class Echo(torchvision.datasets.VisionDataset):
    ...
    def __getitem__(self, index):
        ...
        if target != [] and 'EF' in self.target_type:
